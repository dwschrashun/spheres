...
var seedShapes = function(){
	var shapes = [{
        ...
        {name: "Aries",
        stars: [
            {x:900 , y:200 , nextX: 1000, nextY:250 , note: "A3"},
            {x:1000 , y:250 , nextX: 1075, nextY: 275, note: "C#4"},
            {x:1075 , y:275 , nextX: 1075, nextY: 275, note: "E4"},
        ]},

        {name: "Orion",
        stars: [
            {x:900 , y:250 , nextX:840, nextY:275 , note: "B4"},
            {x:840 , y:275, nextX: 875, nextY: 370, note: "C#4"},
            {x:875 , y:370 , nextX: 890, nextY: 360, note: "E4"},
            {x:890 , y:360 , nextX: 910, nextY: 350, note: "A3"},
            {x:910, y:350 , nextX: 940 , nextY: 290, note: "G#3"},
            {x:940 , y:290 , nextX: 900, nextY: 250 , note: "F#3"},
            {x:850 , y:410 , nextX: 875, nextY: 370, note: "E3"},
            {x:950 , y:400 , nextX: 910, nextY: 350, note: "A4"},
            {x:1000, y:330 , nextX: 940, nextY: 290, note: "B3"},
            {x:910 , y:360 , nextX: 1000, nextY: 330 , note: "C#3"},
        ]},
        ...
        stars: [
            ...
            {x:325, y:440 , nextX: 320 , nextY: 415, note: "C#3"},
            {x:320 , y:415 , nextX: 330, nextY: 475, note: "E3"},
            {x:330 , y:475 , nextX: 340, nextY: 465, note: "G#3"},
